 ...
 */
public class JDBCRedShiftHelper {
    private Connection connection;
    private Statement statement;
    private String connectionString;
    private ResultSet resultSet;

    public JDBCRedShiftHelper(String host, String port) throws InterruptedException, SQLException {
        this.connectionString = "jdbc:redshift://" + host + ":" + port;
        this.connection = DriverManager.getConnection(this.connectionString);
        this.statement = this.connection.createStatement(1004, 1007);
    }

    public JDBCRedShiftHelper(String host, String port, String userId, String password) throws InterruptedException, SQLException {
        this.connectionString = "jdbc:redshift://" + host + ":" + port + "/cds;";
    ...
    public JDBCRedShiftHelper(String host, String port, String userId, String password , String ssl , String cert) throws InterruptedException, SQLException {
        this.connectionString = "jdbc:redshift://" + host + ":" + port + "/cds?ssl=true&sslfactory=com.amazon.redshift.ssl.NonValidatingFactory;";
        System.out.println("connection string::" + this.connectionString);
        Properties props = new Properties();
        props.setProperty("user", userId);
        props.setProperty("password", password);
    ...
    public JDBCRedShiftHelper(String host, String port, String dataBaseName, String userName, String pwd) throws InterruptedException, SQLException {
        this.connection = DriverManager.getConnection("jdbc:redshift://" + host + ":" + port + ";DatabaseName=" + dataBaseName + "", userName, pwd);
        this.statement = this.connection.createStatement(1004, 1007);
    }
    ...
    static {
        try {
            ...
            System.out.println("Redshift JDBC Driver is missing");
